...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    // console.log(cartlists.results[1].product);
    // console.log(cartlists.results[1].product.description);
      ...
      <div class="content">
        <div class="product-list">
          <div class="product">
            {
              cartlists["results"] &&
              cartlists["results"].map((cartlist) => (
                <>
                  <div class="product-image">
                    <img src={cartlist.product.image} alt=" " />
                  </div>
                  <div class="product-info">
                    <div class="name">{cartlist.product.name}</div>
                    <div class="bottom">
                      <div class="price">${cartlist.product.price}</div>
        ...
        <section class="checkout-area">
          <div class="cartinfo-total">
            ...
            <div class="itemandprice">
              ...
              <h4 class="total-value">${subtotal}</h4>
            </div>
